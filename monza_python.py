...
DEFAULT_SIMULATION_DURATION = 11 # seconds
...
def main():
    ...
    # Save final frame to results folder
    dashboard.save_final_frame('results/dashboard_final.png')
    # Save each subplot individually
    dashboard.save_all_subplots()
    dashboard.show()
